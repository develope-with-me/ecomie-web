            ...
            <div className="relative z-10 container mx-auto px-4 text-center">
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="inline-flex items-center px-4 py-2 rounded-full bg-heavenly-light/90 text-primary border border-accent/30 mb-6">
                        ...
                        <span className="text-sm font-medium">{t("homePage.empoweringEvangelist")}</span>
                    </div>

                    {/* Heading */}
                    <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-primary-foreground mb-6 leading-tight">
                        {t("homePage.trackYour")}&nbsp;
                        <span className="text-accent block md:inline">{t("homePage.evangelismImpact")}</span>
                    </h1>

                    {/* Subheading */}
                    <p className="text-xl md:text-2xl text-primary-foreground/90 mb-8 max-w-3xl mx-auto leading-relaxed">
                        {t("homePage.joinEvangelistsUsingOur...")}
                    </p>

                    {/* CTA Buttons */}
                    <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
                        <Button variant="cta" size="lg" className="px-8 py-4 text-lg">
                            <Link to={'/ui/signUp'}>{t("homePage.startYourJourney")}</Link>
